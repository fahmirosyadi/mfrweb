...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" th:href="@{/assets/user/img/favicon.png}">
    <!-- Place favicon.ico in the root directory -->

    <!-- CSS here -->
    <link rel="stylesheet" th:href="@{/assets/user/css/bootstrap.min.css}" media="all"/>
    <link rel="stylesheet" th:href="@{/assets/user/css/owl.carousel.min.css}" media="all"/>
    <link rel="stylesheet" th:href="@{/assets/user/css/magnific-popup.css}" media="all"/>
    <link rel="stylesheet" th:href="@{/assets/user/css/font-awesome.min.css}" media="all"/>
    <link rel="stylesheet" th:href="@{/assets/user/css/themify-icons.css}" media="all"/>
    <link rel="stylesheet" th:href="@{/assets/user/css/nice-select.css}" media="all"/>
    <link rel="stylesheet" th:href="@{/assets/user/css/flaticon.css}" media="all"/>
    <link rel="stylesheet" th:href="@{/assets/user/css/gijgo.css}" media="all"/>
    <link rel="stylesheet" th:href="@{/assets/user/css/animate.css}" media="all"/>
    <link rel="stylesheet" th:href="@{/assets/user/css/slicknav.css}" media="all"/>
    <!-- <link rel="stylesheet" href="user/style.css"> -->
    <link th:href="@{/assets/user/css/style.css}" rel="stylesheet" media="all">
...
<body>
                        ...
                        <div class="col-lg-12">
                            <div class="header_wrap d-flex justify-content-between align-items-center">
                                <div class="header_left">
                                    <div class="logo">
                                        <a href="index.html">
                                            <img th:src="@{'/assets/user/img/logo.png'}" alt="">
                                        </a>
                                    </div>
                                </div>
    ...
    <div class="slider_area">
        <div class="slider_active owl-carousel">
            <!-- single_carouse -->
            <div class="single_slider  d-flex align-items-center" th:style="'background-image: url(/uploads/bg1.jpeg)'">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                ...
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img th:src="@{'/assets/user/img/program/1.png'}" alt="">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img th:src="@{'/assets/user/img/program/2.png'}" alt="">
                                </div>
                                <div class="program__content">
                                    <span>Agriculture</span>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img th:src="@{'/assets/user/img/program/3.png'}" alt="">
                                </div>
                                <div class="program__content">
                                    <span>Agriculture</span>
            ...
            <div class="row">
                    ...
                    <div class="single__news">
                        <div class="thumb">
                            <a href="single-blog.html">
                                <img th:src="@{'/assets/user/img/news/1.png'}" alt="">
                            </a>
                ...
                <div class="col-md-6">
                    <div class="single__news">
                        <div class="thumb">
                            <a href="single-blog.html">
                                <img th:src="@{'/assets/user/img/news/2.png'}" alt="">
                            </a>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- JS here -->
    <script th:src="@{'/assets/user/js/vendor/modernizr-3.5.0.min.js'}"></script>
    <script th:src="@{'/assets/user/js/vendor/jquery-1.12.4.min.js'}"></script>
    <script th:src="@{'/assets/user/js/popper.min.js'}"></script>
    <script th:src="@{'/assets/user/js/bootstrap.min.js'}"></script>
    <script th:src="@{'/assets/user/js/owl.carousel.min.js'}"></script>
    <script th:src="@{'/assets/user/js/isotope.pkgd.min.js'}"></script>
    <script th:src="@{'/assets/user/js/ajax-form.js'}"></script>
    <script th:src="@{'/assets/user/js/waypoints.min.js'}"></script>
    <script th:src="@{'/assets/user/js/jquery.counterup.min.js'}"></script>
    <script th:src="@{'/assets/user/js/imagesloaded.pkgd.min.js'}"></script>
    <script th:src="@{'/assets/user/js/scrollIt.js'}"></script>
    <script th:src="@{'/assets/user/js/jquery.scrollUp.min.js'}"></script>
    <script th:src="@{'/assets/user/js/wow.min.js'}"></script>
    <script th:src="@{'/assets/user/js/nice-select.min.js'}"></script>
    <script th:src="@{'/assets/user/js/jquery.slicknav.min.js'}"></script>
    <script th:src="@{'/assets/user/js/jquery.magnific-popup.min.js'}"></script>
    <script th:src="@{'/assets/user/js/plugins.js'}"></script>
    <script th:src="@{'/assets/user/js/gijgo.min.js'}"></script>

    <!--contact js-->
    <script th:src="@{'/assets/user/js/contact.js'}"></script>
    <script th:src="@{'/assets/user/js/jquery.ajaxchimp.min.js'}"></script>
    <script th:src="@{'/assets/user/js/jquery.form.js'}"></script>
    <script th:src="@{'/assets/user/js/jquery.validate.min.js'}"></script>
    <script th:src="@{'/assets/user/js/mail-script.js'}"></script>
